...
$(document).ready(function(){
	...
	var geocodeQueryURL = 'https://maps.googleapis.com/maps/api/geocode/json?address=' + query + '&key=AIzaSyAzBECPmc6z_ppq-pud2BgfA6bmZOnC25s';
		...
		$.ajax({url: geocodeQueryURL, method: 'GET'})
			...
			var showLocation = $('#weatherDisplay');
			...
			showLocationFill.append('<div class="col-md-6" id="weatherInfo"><h2><i class="glyphicon glyphicon-globe"></i> ' + location + ' <span class="text-smaller">('  + latitude.toFixed(2) + ' , ' + longitude.toFixed(2) + ')</span></h2></div>');
...
var news= 'https://webhose.io/search?token=a3503ff7-0311-4ddb-b864-722cd7632549&format=json&q='+query+'&location='+query+'&thread.title='+query+'';

...
$(document).ready(function(){
	...
	var geocodeQueryURL = 'https://maps.googleapis.com/maps/api/geocode/json?address=' + query + '&key=AIzaSyAzBECPmc6z_ppq-pud2BgfA6bmZOnC25s';
		...
		$.ajax({url: geocodeQueryURL, method: 'GET'})
			...
			var googlePlaceQueryURL ='https://maps.googleapis.com/maps/api/place/textsearch/json?query=' + location.trim() + '&key=AIzaSyDWy1HdPMsWJKHz-ZCCZ7nOugsFJFvVxm0'

			$.ajax({url: googlePlaceQueryURL, method: 'GET'})
			.done(function(response) {
